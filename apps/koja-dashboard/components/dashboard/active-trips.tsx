    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-fg-muted">{liveCount} live</span>
        </div>
      </CardHeader>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <p className="text-sm font-medium text-fg truncate">{trip.driver}</p>
                    <span className="text-fg-dim">·</span>
                    <span className="text-xs text-fg-muted">{trip.bus}</span>
                  </div>
                  <p className="text-xs text-fg-muted mt-0.5">{trip.route}</p>
                ...
                <div className="text-right shrink-0">
                  ...
                  <p className="text-xs text-fg-muted">{formatNGN(trip.revenue)}</p>
                </div>
              </div>
            )
          })}
