...
export const NOTIFICATION_TEMPLATES: NotificationTemplate[] = [
  ...
  {
    id: "ntf_mandate_multi_account",
    event: "Multi-account mandate requirement",
    trigger: "mandate.fanout_requested",
    channels: ["SMS", "EMAIL"],
    audience: ["BORROWER"],
    subject: "Repayment Mandates Requested on All Linked Accounts",
    body: "VBank: To secure your loan repayment, mandate requests have been sent to every bank account linked to your BVN. Please validate each one you receive.",
    enabled: true,
  },
  {
    id: "ntf_mandate_timeout_officer",
    event: "Mandate validation timed out",
    trigger: "mandate.validation_timeout",
    channels: ["DASHBOARD", "EMAIL"],
    audience: ["DRO", "DRM"],
    subject: "Mandate Validation Not Completed",
    body: "A mandate request was not validated by the borrower within the 24h window and has been automatically cancelled (MANDATE VALIDATION NOT COMPLETED). The borrower has been prompted to restart mandate setup.",
    enabled: true,
  },
  {
